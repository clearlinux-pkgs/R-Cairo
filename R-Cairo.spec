...
Version  : 1.6.1
Release  : 95
URL      : https://cran.r-project.org/src/contrib/Cairo_1.6-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Cairo_1.6-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694732819
